 ...
 */
async function generateAgentCommands(projectPath, aiAssistant, _scriptType) {
  ...
  // Note: scriptType is used for release ZIP selection ('sh'/'ps'), but scripts are always in 'bash' directory
  const scriptBasePath = '.vibedraft/scripts/bash';
